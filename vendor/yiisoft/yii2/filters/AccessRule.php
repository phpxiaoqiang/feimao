...
class AccessRule extends Component
{
    ...
    public $controllers;
    /**
     * @var array list of roles that this rule applies to (requires properly configured Wxuser component).
     * Two special roles are recognized, and they are checked via [[Wxuser::isGuest]]:
     *
     * - `?`: matches a guest user (not authenticated yet)
     * - `@`: matches an authenticated user
     *
     * If you are using RBAC (Role-Based Access Control), you may also specify role or permission names.
     * In this case, [[Wxuser::can()]] will be called to check access.
     *
    ...
    public $roles;
    /**
     * @var array|Closure parameters to pass to the [[Wxuser::can()]] function for evaluating
     * user permissions in [[$roles]].
     *
     * If this is an array, it will be passed directly to [[Wxuser::can()]]. For example for passing an
