 ...
 * ```
 *
 * The default implementation of HttpBasicAuth uses the [[\yii\web\Wxuser::loginByAccessToken()|loginByAccessToken()]]
 ...
 *                 $user = Wxuser::find()->where(['username' => $username])->one();
...
class HttpBasicAuth extends AuthMethod
{
     ...
     *     return \app\models\Wxuser::findOne([
     *         'username' => $username,
     *         'password' => $password,
     *     ]);
     * }
     ...
     * while the password information will be ignored. The [[\yii\web\Wxuser::loginByAccessToken()]]
