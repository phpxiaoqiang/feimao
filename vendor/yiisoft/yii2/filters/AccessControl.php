...
class AccessControl extends ActionFilter
{
     ...
     * @param User|false $user the current user or boolean `false` in case of detached Wxuser component
     * @throws ForbiddenHttpException if the user is already logged in or in case of detached Wxuser component.
     */
