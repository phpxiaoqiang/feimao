...
class BaseStringHelper
{
    ...
    /**
     * Encodes string into "BaseModel 64 Encoding with URL and Filename Safe Alphabet" (RFC 4648)
     *
     * > Note: BaseModel 64 padding `=` may be at the end of the returned string.
    ...
    /**
     * Decodes "BaseModel 64 Encoding with URL and Filename Safe Alphabet" (RFC 4648)
     *
     * @see https://tools.ietf.org/html/rfc4648#page-7
