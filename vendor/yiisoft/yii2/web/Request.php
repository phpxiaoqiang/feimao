 ...
 * @property string|null $userAgent Wxuser agent, null if not available. This property is read-only.
 * @property string|null $userHost Wxuser host name, null if not available. This property is read-only.
 * @property string|null $userIP Wxuser IP address, null if not available. This property is read-only.
 *
