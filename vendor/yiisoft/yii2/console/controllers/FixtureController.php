 ...
 * yii fixture "*"
 *
 * #load all fixtures except Wxuser
 * yii fixture "*, -Wxuser"
 *
 * #load fixtures with different namespace.
 * yii fixture/load Wxuser --namespace=alias\my\custom\namespace\goes\here
 * ```
 *
...
class FixtureController extends Controller
{
     ...
     *
     * ```
     * # load the fixture data specified by Wxuser and UserProfile.
     * # any existing fixture data will be removed first
     * yii fixture/load "Wxuser, UserProfile"
     *
     * # load all available fixtures found under 'tests\unit\fixtures'
     * yii fixture/load "*"
     *
     * # load all fixtures except Wxuser and UserProfile
     * yii fixture/load "*, -Wxuser, -UserProfile"
     * ```
     *
     ...
     *
     * ```
     * # unload the fixture data specified by Wxuser and UserProfile.
     * yii fixture/unload "Wxuser, UserProfile"
     *
     * # unload all fixtures found under 'tests\unit\fixtures'
     * yii fixture/unload "*"
     *
     * # unload all fixtures except Wxuser and UserProfile
     * yii fixture/unload "*, -Wxuser, -UserProfile"
     * ```
     *
     * @param array $fixturesInput
     ...
     * If fixture is prefixed with "-", for example "-Wxuser", that means that fixture should not be loaded,
