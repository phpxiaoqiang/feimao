...
namespace common\libraries\sms\api_demo;
...
class SmsDemo
{
    ...
    public static function getAcsClient()
    {
        ...
        $accessKeyId = "LTAI1n0YgnsxQLYg"; // AccessKeyId

        $accessKeySecret = "hP3WCeTsM94bZ0k7WBBSNsGCKFr1GC"; // AccessKeySecret
    ...
    public static function sendSms($phone, $data)
    {
        ...
        $request->setSignName("Chic原醉咨询服务");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_121907222");
//        $request->setTemplateCode("SMS_121907222");
